from pipeline.datasets.cartoon_set_face_shape import create_face_shape_df, create_face_shape_test_df
...
class B1MLP(B1):
    def __init__(
        ...
        self.train_gen, self.val_gen = B1.train_gen, B1.val_gen
